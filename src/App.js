    ...
    <div className="wrapper clear">
      ...
      <div className="content p-40">
       ...
       <div className="card">
        ...
        <div className="card">
          <img width={138} height={92} src="/img/sneakers/2.jpg" alt="Sneakers" />
          <h5>Man's running Shoes</h5>
          <div className="d-flex justify-between align-center">
            <div className="d-flex flex-column">
              <span>Price:</span>
        ...
        <div className="card">
          <img width={138} height={92} src="/img/sneakers/3.jpg" alt="Sneakers" />
          <h5>Man's running Shoes</h5>
          <div className="d-flex justify-between align-center">
            <div className="d-flex flex-column">
              <span>Price:</span>
        ...
        <div className="card">
          <img width={138} height={92} src="/img/sneakers/4.jpg" alt="Sneakers" />
          <h5>Man's running Shoes</h5>
          <div className="d-flex justify-between align-center">
            <div className="d-flex flex-column">
              <span>Price:</span>
